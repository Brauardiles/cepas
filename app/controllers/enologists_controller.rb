class EnologistsController < ApplicationController
  ...
  private
    ...
    def enologist_params
      params.require(:enologist).permit(:name, :age, :nationality, magazines_attributes:[:id, :name], positions_attributes:[:id, :name], contracts_attributes:[:position_id, :magazine_id])
    end
end
